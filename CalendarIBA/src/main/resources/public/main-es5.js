...
var AddWorkAddComponent = /** @class */ (function () {
    function AddWorkAddComponent(formBuilder, groupService, teachersService, addWorkOfTeacherService, route, router) {
    ...
    AddWorkAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        var date = new Date();
        var endDate = new Date(date.getFullYear(), date.getMonth(), 1).toISOString().split('T')[0];
        ...
        this.teachersService.getTeachers().subscribe(function (res) {
            _this.teachers = res;
        });
        this.groupService.getGroups().subscribe(function (res) {
            _this.groups = res;
        });
        this.addWorkOfTeacherService.getTypesOfAddWork().subscribe(function (res) {
            _this.typesOfAddWork = res;
        });
    };
    AddWorkAddComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.addWorkForm.value);
        var newAddWork = new _add_work_of_teacher_model__WEBPACK_IMPORTED_MODULE_6__["AddWorkOfTeacherDto"]();
        newAddWork.id = null;
        ...
        this.addWorkOfTeacherService.addNewWork(newAddWork).subscribe(function () { return _this.gotoAddWorkList(); });
    };
    AddWorkAddComponent.prototype.gotoAddWorkList = function () {
        this.router.navigate(['/addWork']);
    };
    AddWorkAddComponent.ctorParameters = function () { return [
...
var AddWorkEditComponent = /** @class */ (function () {
    function AddWorkEditComponent(formBuilder, groupService, teachersService, addWorkOfTeacherService, route, router) {
        this.formBuilder = formBuilder;
        this.groupService = groupService;
        this.teachersService = teachersService;
        this.addWorkOfTeacherService = addWorkOfTeacherService;
    ...
    AddWorkEditComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    AddWorkEditComponent.prototype.getAddWork = function (id) {
        var _this = this;
        this.addWorkOfTeacherService.getOneWork(id).subscribe(function (res) {
            console.log(res);
            _this.editWorkForm.patchValue({
                id: res.id,
                date: res.date,
    ...
    AddWorkEditComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.editWorkForm.value);
        var updateAddwork = new _add_work_of_teacher_model__WEBPACK_IMPORTED_MODULE_3__["AddWorkOfTeacherDto"]();
        ...
        this.addWorkOfTeacherService.updateAddWork(updateAddwork)
            .subscribe(function () { console.log('Submitted!'); _this.gotoAddWorkList(); });
    };
    AddWorkEditComponent.prototype.gotoAddWorkList = function () {
        this.router.navigate(['/addWork']);
    };
    AddWorkEditComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
var AddWorkListComponent = /** @class */ (function () {
    function AddWorkListComponent(addWorkOfTeacherService, router, route, authService) {
        this.addWorkOfTeacherService = addWorkOfTeacherService;
        this.router = router;
        this.route = route;
        this.authService = authService;
    }
    AddWorkListComponent.prototype.ngOnInit = function () {
        var date = new Date();
    ...
    Object.defineProperty(AddWorkListComponent.prototype, "isAdminOrManager", {
        get: function () {
    ...
    AddWorkListComponent.prototype.loadAddWorks = function () {
        var _this = this;
    ...
    AddWorkListComponent.prototype.onDeleteAddWork = function (addWork) {
        var _this = this;
        this.addWorkOfTeacherService.deleteAddWork(addWork.id).subscribe(function () {
            _this.loadAddWorks();
        });
    };
    AddWorkListComponent.prototype.onAdd = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
    AddWorkListComponent.ctorParameters = function () { return [
...
var AddWorkOfTeacher = /** @class */ (function () {
    function AddWorkOfTeacher() {
    }
    return AddWorkOfTeacher;
}());

var TypeOfAddWork = /** @class */ (function () {
    function TypeOfAddWork() {
    }
    return TypeOfAddWork;
}());

var AddWorkOfTeacherDto = /** @class */ (function () {
    function AddWorkOfTeacherDto() {
    }
    return AddWorkOfTeacherDto;
}());
...
var AddWorkOfTeacherService = /** @class */ (function () {
    function AddWorkOfTeacherService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    AddWorkOfTeacherService.prototype.getAllAddWork = function (startDate, endDate) {
        var _this = this;
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_3__["UrlConstants"].URL_ADDWORK + "/span?d1=" + startDate + "&d2=" + endDate;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (events) {
            ...
            _this.toastr.info("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
        }));
    };
    AddWorkOfTeacherService.prototype.getOneWork = function (id) {
        var _this = this;
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_3__["UrlConstants"].URL_ADDWORK + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
        }));
    };
    AddWorkOfTeacherService.prototype.addNewWork = function (newWork) {
        var _this = this;
        return this.httpClient.post(_shared_url_constants__WEBPACK_IMPORTED_MODULE_3__["UrlConstants"].URL_ADDWORK, newWork).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
            console.log(err, 'Не удалось добавить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
        }));
    };
    AddWorkOfTeacherService.prototype.updateAddWork = function (addWork) {
        var _this = this;
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_3__["UrlConstants"].URL_ADDWORK + "/" + addWork.id;
        return this.httpClient.put(url, addWork).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
        }));
    };
    AddWorkOfTeacherService.prototype.deleteAddWork = function (id) {
        var _this = this;
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_3__["UrlConstants"].URL_ADDWORK + "/" + id;
        return this.httpClient.delete(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C \u043E \u043D\u0430\u0433\u0440\u0443\u0437\u043A\u0435", 'Ошибка');
            console.log(err, 'Не удалось удалить запись о нагрузке');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
        }));
    };
    AddWorkOfTeacherService.prototype.getTypesOfAddWork = function () {
        var _this = this;
        return this.httpClient.get(_shared_url_constants__WEBPACK_IMPORTED_MODULE_3__["UrlConstants"].URL_TYPE_OF_ADD_WORK).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(null);
        }));
    };
    AddWorkOfTeacherService.ctorParameters = function () { return [
    ...
    return AddWorkOfTeacherService;
}());
...
var AddWorkRoutingModule = /** @class */ (function () {
    function AddWorkRoutingModule() {
    }
...
var AddWorkModule = /** @class */ (function () {
    function AddWorkModule() {
    }
...
/* harmony import */ var _fullcalendar_angular__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @fullcalendar/angular */ "./node_modules/@fullcalendar/angular/fesm5/fullcalendar-angular.js");
...
var SignInComponent = /** @class */ (function () {
    ...
    SignInComponent.prototype.onSubmit = function () {
        ...
        this.authenticationService.login(this.authReqDto).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])())
            .subscribe(function () {
            console.log(_this.authenticationService.userRole);
            if (_this.authenticationService.userRole === 'ROLE_USER') {
                _this.router.navigate(['/reports']);
            }
            else if (_this.authenticationService.userRole === 'ROLE_GROUP') {
                _this.router.navigate(['/reports/timetable-group']);
            }
            else {
...
var ClassroomAddComponent = /** @class */ (function () {
    function ClassroomAddComponent(route, router, classroomService, formBuilder) {
        this.route = route;
        this.router = router;
        this.classroomService = classroomService;
        this.formBuilder = formBuilder;
    }
    ClassroomAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.classroomService.getTypesOfClassroom().subscribe(function (res) {
            _this.typesOfClassroom = res;
        });
    };
    ClassroomAddComponent.prototype.onSubmit = function () {
        var _this = this;
        var classroom = new _shared_models_classroom_model__WEBPACK_IMPORTED_MODULE_4__["Classroom"]();
        ...
        this.classroomService.saveClassroom(classroom).subscribe(function () {
            _this.gotoClassroomList();
        });
    };
    ClassroomAddComponent.prototype.gotoClassroomList = function () {
        this.router.navigate(['/dictionaries/classrooms']);
    };
    ClassroomAddComponent.ctorParameters = function () { return [
...
var ClassroomEditComponent = /** @class */ (function () {
    function ClassroomEditComponent(classroomService, route, router) {
        this.classroomService = classroomService;
        this.route = route;
        this.router = router;
    ...
    ClassroomEditComponent.prototype.getClassroom = function (id) {
        var _this = this;
        this.classroomService.getClassroom(id).subscribe(function (res) {
            console.log(res);
            _this.typeOfClassroom = res.typeOfClassroom.value;
            _this.color = res.color;
            _this.classroomEditForm.patchValue({
                number: res.number,
                typeOfClassroom: res.typeOfClassroom.id,
            });
        });
    };
    ClassroomEditComponent.prototype.createFormGroup = function () {
    ...
    ClassroomEditComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.classroomEditForm.value);
        result.color = this.color;
        console.log(result);
        this.classroomService.updateClassroom(this.id, result)
            .subscribe(function () { console.log('Submitted!'); _this.gotoClassroomList(); });
    };
    ClassroomEditComponent.prototype.gotoClassroomList = function () {
        this.router.navigate(['/dictionaries/classrooms']);
    };
...
var ClassroomListComponent = /** @class */ (function () {
    function ClassroomListComponent(classroomService, router, route) {
        this.classroomService = classroomService;
        this.router = router;
        this.route = route;
    }
    ClassroomListComponent.prototype.ngOnInit = function () {
        this.loadClassrooms();
    };
    ClassroomListComponent.prototype.loadClassrooms = function () {
        var _this = this;
    ...
    ClassroomListComponent.prototype.onDeleteClassroom = function (classroom) {
        var _this = this;
        this.classroomService.deleteClassroom(classroom.id).subscribe(function () {
            _this.loadClassrooms();
        });
    };
    ClassroomListComponent.prototype.onAdd = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
    ClassroomListComponent.ctorParameters = function () { return [
        { type: _shared_services_classroom_service__WEBPACK_IMPORTED_MODULE_3__["ClassroomService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var CourseAddComponent = /** @class */ (function () {
    function CourseAddComponent(route, router, descriptionOfPlanService, typeOfCourseService) {
        this.route = route;
        this.router = router;
    ...
    CourseAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.typeOfCourseService.getTypesOfCourse().subscribe(function (res) {
            _this.typesOfCourse = res;
        });
    ...
    CourseAddComponent.prototype.onSubmit = function (form) {
        var _this = this;
        console.log('Submitted!', form);
        this.descriptionOfPlanService.saveDescriptionOfPlan(form).subscribe(function () { return _this.gotoCoursesList(); });
    };
    CourseAddComponent.prototype.gotoCoursesList = function () {
...
var CourseDetailComponent = /** @class */ (function () {
    function CourseDetailComponent(route, router, descriptionOfPlanService) {
        this.route = route;
        this.router = router;
        this.descriptionOfPlanService = descriptionOfPlanService;
    }
    ...
    CourseDetailComponent.prototype.getCourseDetail = function (id) {
        var _this = this;
        this.descriptionOfPlanService.getDescriptionOfPlan(id).subscribe(function (res) {
            _this.descriptionOfPlan = res;
            console.log(_this.descriptionOfPlan);
            _this.description = res.description;
            _this.id = res.id;
        });
    };
    CourseDetailComponent.prototype.getLessonPlansOfDescr = function (id) {
        var _this = this;
        this.descriptionOfPlanService.getAllLessonPlansOfDescrOfPlan(id).subscribe(function (res) {
            if (res == null) {
                console.log('нет данных');
            }
            else {
                _this.lessonPlans = res;
            }
        });
    };
...
var CourseEditComponent = /** @class */ (function () {
    function CourseEditComponent(route, router, descriptionOfPlanService, typeOfCourseService) {
        this.route = route;
        this.router = router;
        this.descriptionOfPlanService = descriptionOfPlanService;
        this.typeOfCourseService = typeOfCourseService;
    ...
    CourseEditComponent.prototype.getCourse = function (id) {
        var _this = this;
        this.descriptionOfPlanService.getDescriptionOfPlan(id).subscribe(function (res) {
            console.log(res);
            _this.courseEditForm.patchValue({
                description: res.description,
                typeOfCourse: res.typeOfCourse.id,
            });
        });
    };
    CourseEditComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            description: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            typeOfCourse: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]([], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
        });
    ...
    CourseEditComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.courseEditForm.value);
        this.descriptionOfPlanService.updateDescriptionOfPlan(this.id, result)
            .subscribe(function () { console.log('Submitted!'); _this.gotoCoursesList(); });
    };
    CourseEditComponent.prototype.gotoCoursesList = function () {
        this.router.navigate(['/dictionaries/courses']);
    };
    CourseEditComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _shared_services_description_of_plan_service__WEBPACK_IMPORTED_MODULE_4__["DescriptionOfPlanService"] },
        { type: _shared_services_type_of_course_service__WEBPACK_IMPORTED_MODULE_5__["TypeOfCourseService"] }
...
var CourseListComponent = /** @class */ (function () {
    function CourseListComponent(descriptionOfPlanService, router, route, authService) {
        this.descriptionOfPlanService = descriptionOfPlanService;
        this.router = router;
        this.route = route;
        this.authService = authService;
    ...
    Object.defineProperty(CourseListComponent.prototype, "isAdmin", {
        get: function () {
            var role = this.authService.userRole;
            if (role === 'ROLE_ADMIN') {
                return true;
    ...
    Object.defineProperty(CourseListComponent.prototype, "isAdminOrManager", {
        get: function () {
            var role = this.authService.userRole;
            if (role === 'ROLE_ADMIN' || role === 'ROLE_MANAGER') {
                return true;
    ...
    CourseListComponent.prototype.onSelect = function (idCourse) {
    ...
    CourseListComponent.prototype.onDeleteCourse = function (course) {
        var _this = this;
        this.descriptionOfPlanService.deleteDescriptionOfPlan(course.id).subscribe(function () {
            _this.loadCourses();
        });
    };
    CourseListComponent.prototype.onAdd = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
...
var LessonPlanEditComponent = /** @class */ (function () {
    function LessonPlanEditComponent(descriptionOfPlanService, route, router, disciplinesService, teacherService) {
        this.descriptionOfPlanService = descriptionOfPlanService;
        this.route = route;
        this.router = router;
    ...
    LessonPlanEditComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    LessonPlanEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.route.snapshot.params.id;
        this.getDescriptionOfPlan(this.route.snapshot.params.id);
        this.disciplinesService.getDisciplines().subscribe(function (data) {
            _this.disciplines = data;
        });
        this.descriptionOfPlanService.getTypesOfWork().subscribe(function (data) {
            _this.typesOfWork = data;
        });
        this.teacherService.getTeachers().subscribe(function (res) {
            _this.teachersDto = [];
            for (var i = 0, len = Object.keys(res).length; i < len; i++) {
                _this.teachersDto.push({
                    id: res[i].id,
    ...
    LessonPlanEditComponent.prototype.getDescriptionOfPlan = function (id) {
        var _this = this;
        this.descriptionOfPlanService.getDescriptionOfPlan(id).subscribe(function (res) {
            console.log(res);
            _this.descriptionOfPlan = res;
            _this.description = res.description;
            _this.lessonPlanEditForm.patchValue({
                descriptionOfPlanDto: {
                    id: _this.descriptionOfPlan.id,
                    description: _this.descriptionOfPlan.description,
                    typeOfCourse: _this.descriptionOfPlan.typeOfCourse.id
                },
                id: null
            });
        });
    };
    LessonPlanEditComponent.prototype.getLessonPlans = function (id) {
        var _this = this;
        this.descriptionOfPlanService.getAllLessonPlansOfDescrOfPlan(id)
            .subscribe(function (data) {
            console.log(data);
            _this.lessonPlans = data;
        });
    };
    LessonPlanEditComponent.prototype.onAdd = function () {
        var _this = this;
        //  const result: any = Object.assign({}, this.lessonPlanEditForm.value);
        console.log(this.lessonPlanEditForm.value);
        this.descriptionOfPlanService.addlLessonPlansOfDescrOfPlan(this.id, this.lessonPlanEditForm.value).subscribe(function () {
            console.log('Запись добавлена!');
            _this.getLessonPlans(_this.id);
        });
    };
    LessonPlanEditComponent.prototype.onDeleteLessonPlan = function (idL) {
        var _this = this;
    ...
    LessonPlanEditComponent.prototype.onSubmit = function () {
        this.gotoCourseList();
    };
    LessonPlanEditComponent.prototype.gotoCourseList = function () {
        this.router.navigate(['/dictionaries/courses']);
    };
    LessonPlanEditComponent.ctorParameters = function () { return [
    ...
    return LessonPlanEditComponent;
}());
...
var DepartmentAddComponent = /** @class */ (function () {
    function DepartmentAddComponent(route, router, departmentService) {
        this.route = route;
        this.router = router;
    ...
    DepartmentAddComponent.prototype.onSubmit = function (form) {
        var _this = this;
        console.log('Submitted!', form);
        this.departmentService.saveDepartment(form).subscribe(function () { return _this.gotoDepartmentsList(); });
    };
    DepartmentAddComponent.prototype.gotoDepartmentsList = function () {
        this.router.navigate(['/dictionaries/departments']);
    };
    DepartmentAddComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var DepartmentEditComponent = /** @class */ (function () {
    function DepartmentEditComponent(departmentService, route, router) {
        this.departmentService = departmentService;
        this.route = route;
        this.router = router;
    ...
    DepartmentEditComponent.prototype.getDepartment = function (id) {
        var _this = this;
        this.departmentService.getDepartment(id).subscribe(function (res) {
            console.log(res);
            _this.departmentEditForm.patchValue({
                shortName: res.shortName,
                name: res.name,
            });
        });
    };
    DepartmentEditComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            shortName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
        });
    };
    DepartmentEditComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.departmentEditForm.value);
        this.departmentService.updateDepartment(this.id, result)
            .subscribe(function () { console.log('Submitted!'); _this.gotoCoursesList(); });
    };
    DepartmentEditComponent.prototype.gotoCoursesList = function () {
        this.router.navigate(['/dictionaries/departments']);
    };
    DepartmentEditComponent.ctorParameters = function () { return [
        { type: _shared_services_department_service__WEBPACK_IMPORTED_MODULE_4__["DepartmentService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var DepartmentListComponent = /** @class */ (function () {
    function DepartmentListComponent(departmentService, router, route) {
        this.departmentService = departmentService;
        this.router = router;
        this.route = route;
    }
    ...
    DepartmentListComponent.prototype.loadDepartments = function () {
        var _this = this;
    ...
    DepartmentListComponent.prototype.onDeleteDepartment = function (department) {
        var _this = this;
        this.departmentService.deleteDepartment(department.id).subscribe(function () {
...
var DictionariesComponent = /** @class */ (function () {
    function DictionariesComponent(authService) {
        this.authService = authService;
        this._opened = true;
        this._modeNum = 1;
        this._positionNum = 0;
    ...
    Object.defineProperty(DictionariesComponent.prototype, "isAdmin", {
        get: function () {
            var role = this.authService.userRole;
            if (role === 'ROLE_ADMIN') {
                return true;
    ...
    Object.defineProperty(DictionariesComponent.prototype, "isAdminOrManagerOrView", {
        get: function () {
            var role = this.authService.userRole;
    ...
    DictionariesComponent.prototype._toggleOpened = function () {
        this._opened = !this._opened;
    };
    DictionariesComponent.prototype._toggleMode = function () {
        this._modeNum++;
        if (this._modeNum === this._MODES.length) {
            this._modeNum = 0;
        }
    };
    DictionariesComponent.prototype._toggleAutoCollapseHeight = function () {
        this._autoCollapseHeight = this._autoCollapseHeight ? null : 300;
    };
    DictionariesComponent.prototype._toggleAutoCollapseWidth = function () {
        this._autoCollapseWidth = this._autoCollapseWidth ? null : 500;
    };
    DictionariesComponent.prototype._togglePosition = function () {
        this._positionNum++;
        if (this._positionNum === this._POSITIONS.length) {
            this._positionNum = 0;
        }
    };
    DictionariesComponent.prototype._toggleDock = function () {
        this._dock = !this._dock;
    };
    DictionariesComponent.prototype._toggleCloseOnClickOutside = function () {
        this._closeOnClickOutside = !this._closeOnClickOutside;
    };
    DictionariesComponent.prototype._toggleCloseOnClickBackdrop = function () {
        this._closeOnClickBackdrop = !this._closeOnClickBackdrop;
    };
    DictionariesComponent.prototype._toggleShowBackdrop = function () {
        this._showBackdrop = !this._showBackdrop;
    };
    DictionariesComponent.prototype._toggleAnimate = function () {
        this._animate = !this._animate;
    };
    DictionariesComponent.prototype._toggleTrapFocus = function () {
        this._trapFocus = !this._trapFocus;
    };
    DictionariesComponent.prototype._toggleAutoFocus = function () {
        this._autoFocus = !this._autoFocus;
    };
    DictionariesComponent.prototype._toggleKeyClose = function () {
        this._keyClose = !this._keyClose;
    };
    DictionariesComponent.ctorParameters = function () { return [
...
var DisciplineAddComponent = /** @class */ (function () {
    function DisciplineAddComponent(route, router, disciplineService) {
        this.route = route;
        this.router = router;
        this.disciplineService = disciplineService;
    }
    DisciplineAddComponent.prototype.ngOnInit = function () {
    ...
    DisciplineAddComponent.prototype.onSubmit = function (form) {
        var _this = this;
        console.log('Submitted!', form);
        this.disciplineService.saveDisciplines(form).subscribe(function () { return _this.gotoDisciplineList(); });
    };
    DisciplineAddComponent.prototype.gotoDisciplineList = function () {
        this.router.navigate(['/dictionaries/disciplines']);
    };
    DisciplineAddComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var DisciplineDetailComponent = /** @class */ (function () {
    function DisciplineDetailComponent(route, router, disciplineService) {
        this.route = route;
        this.router = router;
        this.disciplineService = disciplineService;
    }
    DisciplineDetailComponent.prototype.ngOnInit = function () {
        this.getDisciplineDetail(this.idDisc);
    };
    DisciplineDetailComponent.prototype.getDisciplineDetail = function (id) {
        var _this = this;
        this.disciplineService.getDiscipline(id).subscribe(function (res) {
            _this.discipline = res;
            // console.log(this.discipline)
            _this.id = res.id;
            _this.disciplineName = res.disciplineName;
            _this.shortDisciplineName = res.shortDisciplineName;
        });
    };
    DisciplineDetailComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _shared_services_disciplines_service__WEBPACK_IMPORTED_MODULE_3__["DisciplinesService"] }
    ]; };
    ...
    return DisciplineDetailComponent;
}());
...
var DisciplineEditComponent = /** @class */ (function () {
    function DisciplineEditComponent(route, router, disciplineService) {
        this.route = route;
        this.router = router;
        this.disciplineService = disciplineService;
    }
    DisciplineEditComponent.prototype.ngOnInit = function () {
    ...
    DisciplineEditComponent.prototype.getDiscipline = function (id) {
        var _this = this;
        this.disciplineService.getDiscipline(id).subscribe(function (res) {
            console.log(res);
            _this.discipline = res;
            _this.disciplineForm.setValue({
                disciplineName: res.disciplineName,
                shortDisciplineName: res.shortDisciplineName
            });
        });
    };
    DisciplineEditComponent.prototype.onSubmit = function (form) {
        var _this = this;
        this.disciplineService.updateDiscipline(this.id, form)
            .subscribe(function () {
            _this.router.navigate(['/dictionaries/disciplines']);
        }, function (err) {
            console.log(err);
        });
    };
    DisciplineEditComponent.prototype.onCancel = function () {
        this.router.navigate(['/dictionaries/disciplines'], { relativeTo: this.route });
    };
    DisciplineEditComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _shared_services_disciplines_service__WEBPACK_IMPORTED_MODULE_3__["DisciplinesService"] }
    ]; };
    ...
    return DisciplineEditComponent;
}());
...
var DisciplineListComponent = /** @class */ (function () {
    function DisciplineListComponent(disciplineService, router, route) {
        this.disciplineService = disciplineService;
        this.router = router;
        this.route = route;
        this.rowSelected = -1;
    }
    DisciplineListComponent.prototype.ngOnInit = function () {
    ...
    DisciplineListComponent.prototype.onSelect = function (idDisc) {
        if (this.rowSelected === -1) {
    ...
    DisciplineListComponent.prototype.loadDisciplines = function () {
        var _this = this;
    ...
    DisciplineListComponent.prototype.onDeleteDiscipline = function (discipline) {
        var _this = this;
        this.disciplineService.deleteDiscipline(discipline.id).subscribe(function () {
            _this.loadDisciplines();
        });
    };
    DisciplineListComponent.prototype.onAdd = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
    DisciplineListComponent.ctorParameters = function () { return [
    ...
    return DisciplineListComponent;
}());
...
var EmployeeAddComponent = /** @class */ (function () {
    function EmployeeAddComponent(employeeService, route, router, departmentService) {
    ...
    EmployeeAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.employeeService.getTypesOfPOsition().subscribe(function (res) {
            _this.typesOfPosition = res;
        });
        this.departmentService.getDepartments().subscribe(function (data) {
            _this.departments = data;
        });
    };
    EmployeeAddComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    EmployeeAddComponent.prototype.onSubmit = function () {
        ...
        this.employeeService.saveEmployee(this.employeeAddForm.value)
            .subscribe(function () { _this.gotoEmployeeList(); });
        console.log('Submitted!');
    };
    EmployeeAddComponent.prototype.gotoEmployeeList = function () {
        this.router.navigate(['/dictionaries/employees']);
    };
    EmployeeAddComponent.ctorParameters = function () { return [
...
var EmployeeDetailComponent = /** @class */ (function () {
    ...
    EmployeeDetailComponent.prototype.getEmployeeDetail = function (id) {
        ...
        this.employeeService.getEmployee(id).subscribe(function (res) {
            ...
            _this.patronymic = res.patronymic;
            _this.typeOfPosition = res.typeOfPosition.value;
            if (res.departmentDto) {
                _this.departmentDto = res.departmentDto.name;
            }
            else {
                _this.departmentDto = 'Нет';
            }
...
var EmployeeEditComponent = /** @class */ (function () {
    function EmployeeEditComponent(employeeService, route, router, departmentService) {
        this.employeeService = employeeService;
        this.route = route;
        this.router = router;
        this.departmentService = departmentService;
    ...
    EmployeeEditComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            lastName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            firstName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            patronymic: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
    ...
    EmployeeEditComponent.prototype.getEmployee = function (id) {
        ...
        this.employeeService.getEmployee(id).subscribe(function (res) {
            console.log(res);
            _this.employeeEditForm.patchValue({
    ...
    EmployeeEditComponent.ctorParameters = function () { return [
        { type: _shared_services_employee_service__WEBPACK_IMPORTED_MODULE_3__["EmployeeService"] },
...
var EmployeeListComponent = /** @class */ (function () {
    function EmployeeListComponent(employeeService, router, route) {
        this.employeeService = employeeService;
        this.router = router;
        this.route = route;
        this.rowSelected = -1;
    ...
    EmployeeListComponent.prototype.onSelect = function (idEmp) {
        if (this.rowSelected === -1) {
    ...
    EmployeeListComponent.prototype.onDeleteEmployee = function (employee) {
        var _this = this;
        this.employeeService.deleteEmployee(employee.id).subscribe(function () {
            _this.loadEmployees();
        });
    };
...
var GroupAddStudentsComponent = /** @class */ (function () {
    function GroupAddStudentsComponent(formBuilder, route, router, groupService) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
        this.groupService = groupService;
    ...
    GroupAddStudentsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.route.snapshot.params.id;
        this.groupService.getGroup(this.id).subscribe(function (res) {
            _this.groupName = res.groupName;
            //  this.group = res;
            _this.studentsAddForm.patchValue({ groupDto: res });
        });
        this.getNumberOfStudents(this.id);
    };
    GroupAddStudentsComponent.prototype.getNumberOfStudents = function (id) {
        var _this = this;
        this.groupService.getAllNumberOfStudents(id).subscribe(function (res) {
            _this.numbersOfStudents = res;
        });
    };
    /*onSubmit() {
    ...
    GroupAddStudentsComponent.prototype.gotoGroupsList = function () {
        this.router.navigate(['/dictionaries/groups']);
    };
    GroupAddStudentsComponent.prototype.onAdd = function () {
        var _this = this;
        var result = Object.assign({}, this.studentsAddForm.value);
        console.log(result);
        var numberOgStudentsDto = new _shared_models_group_model__WEBPACK_IMPORTED_MODULE_3__["NumberOfStudentsDto"]();
        ...
        this.groupService.saveNumberOfStudents(numberOgStudentsDto).subscribe(function () { return _this.gotoGroupsList(); });
    };
    GroupAddStudentsComponent.prototype.onDeleteStudents = function (id) {
        var _this = this;
        this.groupService.deleteNumberOfStudents(id).subscribe(function () {
            console.log('Students is deleted');
            _this.getNumberOfStudents(_this.id);
        });
    };
    GroupAddStudentsComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    ...
    return GroupAddStudentsComponent;
}());
...
var GroupAddComponent = /** @class */ (function () {
    function GroupAddComponent(route, router, groupService, typeOfEducationService, descriptionOfPlanService) {
        this.route = route;
        this.router = router;
        this.groupService = groupService;
    ...
    GroupAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.typeOfEducationService.getTypesOfEducation().subscribe(function (res) {
            _this.typesOfEducation = res;
        });
        this.descriptionOfPlanService.getDescriptionOfPlans().subscribe(function (res) {
            _this.descriptionsOfPlan = [];
            for (var i = 0, len = Object.keys(res).length; i < len; i++) {
                _this.descriptionsOfPlan.push({
                    id: res[i].id,
    ...
    GroupAddComponent.prototype.onSubmit = function () {
        ...
        result.color = this.color;
        console.log(result);
        this.groupService.saveGroup(result).subscribe(function () { return _this.gotoGroupsList(); });
    };
    GroupAddComponent.prototype.gotoGroupsList = function () {
        this.router.navigate(['/dictionaries/groups']);
    };
    GroupAddComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
        { type: _shared_services_group_service__WEBPACK_IMPORTED_MODULE_4__["GroupService"] },
...
var GroupEditComponent = /** @class */ (function () {
    function GroupEditComponent(route, router, groupService, typeOfEducationService, descriptionOfPlanService) {
        this.route = route;
        this.router = router;
        this.groupService = groupService;
        this.typeOfEducationService = typeOfEducationService;
    ...
    GroupEditComponent.prototype.getGroup = function (id) {
        var _this = this;
        this.groupService.getGroup(id).subscribe(function (res) {
            console.log(res);
            console.log(res.descriptionOfPlanDto.id);
            _this.color = res.color;
            _this.groupEditForm.patchValue({
    ...
    GroupEditComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            groupName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            typeOfEducation: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]([], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            descriptionOfPlanDto: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]([], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
    ...
    GroupEditComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = new _shared_models_group_model__WEBPACK_IMPORTED_MODULE_5__["GroupDto"]();
        // result.id = this.id;
        ...
        this.groupService.updateGroup(this.id, result)
            .subscribe(function () { console.log('Submitted!'); _this.gotoGroupList(); });
    };
    GroupEditComponent.prototype.gotoGroupList = function () {
        this.router.navigate(['/dictionaries/groups']);
    };
...
var GroupListComponent = /** @class */ (function () {
    ...
    function GroupListComponent(groupService, router, route) {
        this.groupService = groupService;
        this.router = router;
        this.route = route;
    }
    ...
    GroupListComponent.prototype.onDelete = function (group) {
        var _this = this;
        this.groupService.deleteGroup(group.id).subscribe(function () {
            _this.loadGroups();
        });
    };
    GroupListComponent.prototype.onAdd = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
...
var TeacherAddComponent = /** @class */ (function () {
    function TeacherAddComponent(teachersService, route, router, disciplinesService) {
        this.teachersService = teachersService;
        this.route = route;
        this.router = router;
        this.disciplinesService = disciplinesService;
    ...
    TeacherAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.teachersService.getTypesOfEmployment().subscribe(function (res) {
            _this.types = res;
        });
        this.disciplinesService.getDisciplines().subscribe(function (data) {
            _this.disciplines = data;
    ...
    TeacherAddComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
    ...
    TeacherAddComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.teacherAddForm.value);
        ...
        this.teachersService.saveTeacher(result.teacherData)
            ...
            _this.id = res.id;
            for (var i = 0, len = Object.keys(_this.discId).length; i < len; i++) {
                _this.teachersService.addDisciplineToTeacher(_this.id, result.disciplinesData[i])
                    .subscribe();
            }
            _this.gotoTeacherList();
        });
        console.log('Submitted!');
    };
    TeacherAddComponent.prototype.gotoTeacherList = function () {
...
var TeacherDetailComponent = /** @class */ (function () {
    function TeacherDetailComponent(route, router, teachersService) {
        this.route = route;
        this.router = router;
        this.teachersService = teachersService;
    }
    ...
    TeacherDetailComponent.prototype.getTeacherDetail = function (id) {
        var _this = this;
        this.teachersService.getTeacher(id).subscribe(function (res) {
            _this.teacher = res;
            ...
            _this.firstName = res.firstName;
            _this.patronymic = res.patronymic;
            _this.typeOfEmployment = res.typeOfEmployment.value;
        });
    };
    TeacherDetailComponent.prototype.getTeacherDisciplines = function (id) {
        var _this = this;
        this.teachersService.getAllDisciplinesOfTeacher(id).subscribe(function (res) {
            if (res == null) {
                console.log('нет данных');
            }
            else {
                _this.disciplines = res;
            }
        });
    };
...
var TeacherEditDisciplinesComponent = /** @class */ (function () {
    function TeacherEditDisciplinesComponent(teachersService, route, router, disciplinesService) {
        this.teachersService = teachersService;
        this.route = route;
        this.router = router;
        this.disciplinesService = disciplinesService;
    ...
    TeacherEditDisciplinesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.id = this.route.snapshot.params.id;
    ...
    TeacherEditDisciplinesComponent.prototype.getTeacher = function (id) {
        var _this = this;
        this.teachersService.getTeacher(id).subscribe(function (res) {
            console.log(res);
            _this.teacher = res;
    ...
    TeacherEditDisciplinesComponent.prototype.getDisciplines = function (id) {
        var _this = this;
        this.teachersService.getAllDisciplinesOfTeacher(id)
            .subscribe(function (data) {
            _this.selectedDisciplines = data;
        });
    };
    TeacherEditDisciplinesComponent.prototype.createFormGroup = function () {
    ...
    TeacherEditDisciplinesComponent.prototype.onDeleteSelectedDiscipline = function (idD) {
        var _this = this;
        this.teachersService.deleteDisciplineOfTeacher(this.id, idD)
            .subscribe(function () {
            console.log('Discipline is deleted');
            _this.getDisciplines(_this.id);
        });
    };
    TeacherEditDisciplinesComponent.prototype.onSubmit = function () {
        var result = Object.assign({}, this.teacherEditDisciplinesForm.value);
        result.disciplinesData = Object.assign({}, result.disciplinesData);
        this.discId = result.disciplinesData;
        console.log(result.disciplinesData);
        for (var i = 0, len = Object.keys(this.discId).length; i < len; i++) {
            this.teachersService.addDisciplineToTeacher(this.id, this.discId[i])
                .subscribe();
        }
        this.gotoTeacherList();
    };
    TeacherEditDisciplinesComponent.prototype.gotoTeacherList = function () {
        this.router.navigate(['/dictionaries/teachers']);
    };
    TeacherEditDisciplinesComponent.ctorParameters = function () { return [
    ...
    return TeacherEditDisciplinesComponent;
}());
...
var TeacherEditComponent = /** @class */ (function () {
    function TeacherEditComponent(teachersService, route, router) {
        this.teachersService = teachersService;
        this.route = route;
        this.router = router;
    ...
    TeacherEditComponent.prototype.getTeacher = function (id) {
        var _this = this;
        this.teachersService.getTeacher(id).subscribe(function (res) {
            console.log(res);
            _this.color = res.color;
            _this.typeOfEmployment = res.typeOfEmployment.value;
            console.log(_this.typeOfEmployment);
            _this.teacherEditForm.patchValue({
                lastName: res.lastName,
                firstName: res.firstName,
                patronymic: res.patronymic,
    ...
    TeacherEditComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            lastName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            firstName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
            patronymic: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
    ...
    // разбираем объект по formgroup (то, что сгруппировано на форме)
    // часть объекта отправляю для добавления на сервер, сразу получаю id препода и с ним добавляю предметы к преподу
    TeacherEditComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.teacherEditForm.value);
        result.color = this.color;
        console.log(result);
    ...
    TeacherEditComponent.prototype.gotoTeacherList = function () {
        this.router.navigate(['/dictionaries/teachers']);
    };
    TeacherEditComponent.ctorParameters = function () { return [
        { type: _shared_services_teachers_service__WEBPACK_IMPORTED_MODULE_3__["TeachersService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] }
    ]; };
...
var TeacherListComponent = /** @class */ (function () {
    function TeacherListComponent(teachersService, router, route) {
        this.teachersService = teachersService;
        this.router = router;
        this.route = route;
        this.rowSelected = -1;
    ...
    TeacherListComponent.prototype.onSelect = function (idTeach) {
        if (this.rowSelected === -1) {
    ...
    TeacherListComponent.prototype.onDeleteTeacher = function (teacher) {
        var _this = this;
        ...
        this.teachersService.deleteTeacher(teacher.id).subscribe(function () {
            _this.loadTeachers();
        });
    };
    TeacherListComponent.prototype.onAdd = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
...
var UserAddComponent = /** @class */ (function () {
    function UserAddComponent(route, router, userService) {
        this.route = route;
        this.router = router;
    ...
    UserAddComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.userService.getAllStatuses().subscribe(function (res) {
            _this.statuses = res;
        });
    ...
    UserAddComponent.prototype.onSubmit = function (form) {
        var _this = this;
        console.log('Submitted!', form);
        this.userService.saveUser(form).subscribe(function () { return _this.gotoUserList(); });
    };
    UserAddComponent.prototype.gotoUserList = function () {
...
var UserEditComponent = /** @class */ (function () {
    ...
    UserEditComponent.prototype.getUser = function (id) {
        var _this = this;
        this.userService.getUser(id).subscribe(function (res) {
            console.log(res);
            _this.userEditForm.patchValue({
    ...
    UserEditComponent.prototype.createFormGroup = function () {
        return new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            username: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required),
    ...
    UserEditComponent.prototype.onSubmit = function () {
        var _this = this;
        var result = Object.assign({}, this.userEditForm.value);
        this.userService.updateUser(this.id, result)
            .subscribe(function () { console.log('Submitted!'); _this.gotoUserList(); });
    };
    UserEditComponent.prototype.gotoUserList = function () {
        this.router.navigate(['/dictionaries/users']);
    };
...
var UserListComponent = /** @class */ (function () {
    ...
    UserListComponent.prototype.onDeleteUser = function (user) {
        var _this = this;
        this.userService.deleteUser(user.id).subscribe(function () {
            _this.loadUsers();
        });
    };
    UserListComponent.prototype.onAdd = function () {
        this.router.navigate(['./add'], { relativeTo: this.route });
    };
    // цвет строки пользователя в зависимости от статуса
    UserListComponent.prototype.setUserColor = function (status) {
        switch (status) {
            case 'ACTIVE':
                return 'green';
            case 'NOT_ACTIVE':
...
var UserRoleComponent = /** @class */ (function () {
    function UserRoleComponent(userService, route, router, formBuilder) {
        this.userService = userService;
        this.route = route;
        this.router = router;
        this.formBuilder = formBuilder;
    ...
    UserRoleComponent.prototype.getUser = function (id) {
        var _this = this;
        this.userService.getUser(id).subscribe(function (res) {
            _this.username = res.username;
        });
    };
    UserRoleComponent.prototype.getUserRole = function (id) {
        var _this = this;
        this.userService.getAllRolesOfUser(id).subscribe(function (res) {
            _this.userRoles = res;
        });
    };
    UserRoleComponent.prototype.gotoUsersList = function () {
        this.router.navigate(['/dictionaries/users']);
    };
    UserRoleComponent.prototype.onAdd = function () {
        var _this = this;
        var result = Object.assign({}, this.userRoleForm.value);
        var role = result.role.id;
        this.userService.addRoleToUser(this.id, role).subscribe(function () { return _this.getUserRole(_this.id); });
    };
    UserRoleComponent.prototype.onDeleteRole = function (idRole) {
        var _this = this;
        this.userService.deleteUserRole(this.id, idRole).subscribe(function () {
            console.log('Role is deleted');
            _this.getUserRole(_this.id);
        });
    };
...
var HeaderComponent = /** @class */ (function () {
    ...
    Object.defineProperty(HeaderComponent.prototype, "isAdminOrManager", {
    ...
    Object.defineProperty(HeaderComponent.prototype, "isAdminOrManagerOrView", {
        get: function () {
            // const role = this.authService.getUserRole();
            var role = this.authService.userRole;
            // if (role === 'ROLE_ADMIN') { return true; } else { return false; }
...
var MainComponent = /** @class */ (function () {
    ...
    function MainComponent(timetableOfClassesService, groupService, teacherService, classroomService) {
    ...
    MainComponent.prototype.ngOnInit = function () {
        ...
        this.classroomService.getClassrooms().subscribe(function (res) {
            _this.classrooms = res;
        });
    };
    MainComponent.prototype.loadClassroomEvents = function () {
        this.isGroup = false;
        this.isTeacher = false;
        this.isClassroom = true;
        this.group = null;
    ...
    MainComponent.prototype.loadGroupEvents = function () {
        this.isGroup = true;
        this.isTeacher = false;
    ...
    MainComponent.prototype.loadTeacherEvents = function () {
        this.isGroup = false;
        this.isTeacher = true;
        this.isClassroom = false;
        this.classroom = null;
    ...
    MainComponent.prototype.loadOneTeacherEvents = function () {
        var _this = this;
    ...
    MainComponent.prototype.loadOneGroupEvents = function () {
        var _this = this;
        if (this.group != null) {
    ...
    MainComponent.prototype.getPeriod = function () {
        var startDay = this.calendarComponent.getApi().view.currentStart;
        var endDay = this.calendarComponent.getApi().view.currentEnd;
        startDay.setDate(startDay.getDate() + 1);
        var start = startDay.toISOString().split('T')[0];
        var end = endDay.toISOString().split('T')[0];
        console.log('?classDate1=' + start + '&classDate2=' + end);
        return '?d1=' + start + '&d2=' + end;
    };
    // метод для передачи Диме периода для ивентов из БД
    MainComponent.prototype.getDaysPeriod = function () {
        var _this = this;
        ...
        if (this.classroom != null) {
            ...
            this.timetableOfClassesService.getTimetableOfClasses(this.time).subscribe(function (data) {
                _this.timetableOfClasses = data;
    ...
    MainComponent.prototype.eventRender = function (info) {
        // console.log(info);
    ...
    MainComponent.prototype.handleEventMouseLeave = function (info) {
...
var ReportListComponent = /** @class */ (function () {
    function ReportListComponent(authService) {
        this.authService = authService;
    }
    ReportListComponent.prototype.ngOnInit = function () {
    };
    Object.defineProperty(ReportListComponent.prototype, "isAdminOrManager", {
        get: function () {
            // const role = this.authService.getUserRole();
            var role = this.authService.userRole;
            // if (role === 'ROLE_ADMIN') { return true; } else { return false; }
    ...
    Object.defineProperty(ReportListComponent.prototype, "isAdminOrManagerOrView", {
        get: function () {
            // const role = this.authService.getUserRole();
            var role = this.authService.userRole;
            // if (role === 'ROLE_ADMIN') { return true; } else { return false; }
    ...
    Object.defineProperty(ReportListComponent.prototype, "isAdminOrManagerOrViewOrUser", {
        get: function () {
            // const role = this.authService.getUserRole();
            var role = this.authService.userRole;
            // if (role === 'ROLE_ADMIN') { return true; } else { return false; }
    ...
    Object.defineProperty(ReportListComponent.prototype, "isAdminOrManagerOrUser", {
        get: function () {
            // const role = this.authService.getUserRole();
            var role = this.authService.userRole;
            // if (role === 'ROLE_ADMIN') { return true; } else { return false; }
...
var ReportViewComponent = /** @class */ (function () {
    function ReportViewComponent(reportService, groupService, teacherService, classroomService, route, router, authService) {
    ...
    Object.defineProperty(ReportViewComponent.prototype, "isUserRole", {
        get: function () {
            // const role = this.authService.getUserRole();
            var role = this.authService.userRole;
            if (role === 'ROLE_USER') {
    ...
    Object.defineProperty(ReportViewComponent.prototype, "isGroupRole", {
        get: function () {
            // const role = this.authService.getUserRole();
            var role = this.authService.userRole;
            if (role === 'ROLE_GROUP') {
    ...
    ReportViewComponent.prototype.gotoReportList = function () {
        this.router.navigate(['/reports']);
    };
    ReportViewComponent.prototype.createFile = function (response) {
        if (this.format === 'XLSX') {
    ...
    ReportViewComponent.prototype.showFile = function (response) {
        /*if (this.format === 'XLSX') {
            this.blob = new Blob([response], {type: 'application/xlsx'});
        ...
        this.blob = new Blob([response], { type: 'application/pdf' });
        var objUrl = URL.createObjectURL(this.blob);
        var iframe = document.getElementById('viewer');
        iframe.setAttribute('src', objUrl);
        URL.revokeObjectURL(objUrl);
    };
    ReportViewComponent.prototype.download = function (format) {
        var _this = this;
    ...
    ReportViewComponent.prototype.showPDF = function () {
        var _this = this;
        switch (this.reportName) {
            case 'timetable': {
                this.reportService.downloadAllTimetableForPeriod(this.format, this.reportName, this.startDate, this.endDate).
                    subscribe(function (response) {
                    _this.showFile(response);
                });
                break;
            }
            case 'timetable-teacher': {
                console.log(this.teacher);
                this.reportService.downloadTimetableForTeacherForPeriod(this.format, this.reportName, this.teacher, this.startDate, this.endDate).subscribe(function (response) {
                    _this.showFile(response);
                });
                break;
            }
            case 'timetable-group': {
                ...
                this.reportService.downloadTimetableForGroupForPeriod(this.format, this.reportName, this.group, this.startDate, this.endDate).subscribe(function (response) {
                    _this.showFile(response);
                });
                break;
            }
...
var ReportService = /** @class */ (function () {
    function ReportService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    ReportService.prototype.downloadReport = function (format, name) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_REPORT + "/" + name + "/" + format + "/" + name;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u043E\u0442\u0447\u0435\u0442", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    };
    ReportService.prototype.downloadReportForPeriod = function (format, name, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_REPORT + "/" + name + "/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            if (err.status === 406) {
                _this.toastr.error("\u0417\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u043F\u0435\u0440\u0438\u043E\u0434\u0430 \u043E\u0442\u0447\u0435\u0442\u0430", 'Ошибка');
    ...
    ReportService.prototype.getDisciplinesReport = function (format, name) {
        var _this = this;
        var url = "" + _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DISCIPLINE_REPORT + format + "/" + name;
        return this.httpClient.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u043E\u0442\u0447\u0435\u0442", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
    ...
    ReportService.prototype.downloadAllTimetableForPeriod = function (format, name, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_REPORT + "/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
    ...
    ReportService.prototype.downloadTimetableForTeacherForPeriod = function (format, name, teacherId, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_REPORT + "/teacher/" + teacherId + "/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
    ...
    ReportService.prototype.downloadTimetableForGroupForPeriod = function (format, name, groupId, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_REPORT + "/group/" + groupId + "/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            if (err.status === 406) {
                _this.toastr.error("\u0417\u0430\u043F\u043E\u043B\u043D\u0438\u0442\u0435 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u043E\u0442\u0447\u0435\u0442\u0430", 'Ошибка');
    ...
    ReportService.prototype.downloadReportForm02015 = function (format, name, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER_REPORT + "/form02015/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
    ...
    ReportService.prototype.downloadReportForm02015ForTeacher = function (id, format, name, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER_REPORT + "/" + id + "/form02015/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
    ...
    ReportService.prototype.downloadReportForm02015ForGroup = function (id, format, name, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER_REPORT + "/group/" + id + "/form02015/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
    ...
    ReportService.prototype.downloadReportGroupConsolidated = function (id, format, name, start, end) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers = headers.append('Accept', 'text/csv; charset=utf-8');
        var url = _shared_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER_REPORT + "/group/" + id + "/consolidated/" + format + "/" + name + "?d1=" + start + "&d2=" + end;
        return this.httpClient.get(url, {
            headers: headers,
            responseType: 'blob'
        })
...
var Page403Component = /** @class */ (function () {
    function Page403Component(router, authService) {
        this.router = router;
        this.authService = authService;
    }
    Page403Component.prototype.ngOnInit = function () {
    };
    Page403Component.prototype.gotoMainPage = function () {
    ...
    Page403Component.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var Page404Component = /** @class */ (function () {
    ...
    Page404Component.prototype.gotoMainPage = function () {
        this.router.navigate(['/main']);
    };
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard.prototype.canActivate = function (next, state) {
        ...
        var myRole = this.authService.userRole;
        var currentToken = this.authService.currentToken;
        var url = state.url;
        if (currentToken) {
...
var JwtInterceptor = /** @class */ (function () {
    ...
    JwtInterceptor.prototype.intercept = function (request, next) {
        var authReq = request;
        var currentToken = this.auth.getToken();
...
var TypeOfClassroom = /** @class */ (function () {
    function TypeOfClassroom() {
    }
    return TypeOfClassroom;
}());

// модификация класса для возврата на сервер
var ClassroomDto = /** @class */ (function () {
    function ClassroomDto() {
    }
    return ClassroomDto;
}());
...
var TypeOfEducation = /** @class */ (function () {
    function TypeOfEducation() {
    }
...
var NumberOfStudents = /** @class */ (function () {
    function NumberOfStudents() {
    }
    return NumberOfStudents;
}());

var NumberOfStudentsDto = /** @class */ (function () {
    function NumberOfStudentsDto() {
    }
    return NumberOfStudentsDto;
}());
...
var TimetableOfClasses = /** @class */ (function () {
    function TimetableOfClasses() {
    }
    return TimetableOfClasses;
}());

var TimetableOfClassesForEvents = /** @class */ (function () {
    function TimetableOfClassesForEvents() {
    }
    return TimetableOfClassesForEvents;
}());

var ExternalEvent = /** @class */ (function () {
    function ExternalEvent() {
    }
    return ExternalEvent;
}());

var TimetableOfClassesDto = /** @class */ (function () {
    function TimetableOfClassesDto() {
    }
...
var AuthenticationService = /** @class */ (function () {
    ...
    Object.defineProperty(AuthenticationService.prototype, "userRole", {
        get: function () {
    ...
    AuthenticationService.prototype.setLoggedIn = function (value) {
        this.loggedIn.next(value);
    };
    Object.defineProperty(AuthenticationService.prototype, "currentToken", {
        get: function () {
    ...
    AuthenticationService.prototype.login = function (authenticationRequestDto) {
        var _this = this;
        return this.http.post(this.auth, authenticationRequestDto)
            ...
            if (err.status === 403) {
                _this.toastr.error("\u0414\u043E\u0441\u0442\u0443\u043F \u0437\u0430\u043F\u0440\u0435\u0449\u0435\u043D", 'Ошибка');
                console.log(err, 'Доступ запрещен');
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
            }
            else {
                _this.toastr.error("\u041D\u0435\u0432\u0435\u0440\u043D\u044B\u0439 \u043B\u043E\u0433\u0438\u043D \u0438\u043B\u0438 \u043F\u0430\u0440\u043E\u043B\u044C", 'Ошибка');
...
var ClassroomService = /** @class */ (function () {
    function ClassroomService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    ClassroomService.prototype.getClassroom = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_CLASSROOM + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
    ...
    ClassroomService.prototype.getClassrooms = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_CLASSROOM).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    ClassroomService.prototype.saveClassroom = function (classroom) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_CLASSROOM, classroom).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) { return _this.toastr.success("\u0410\u0443\u0434\u0438\u0442\u043E\u0440\u0438\u044F " + res.number + " \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0430\u0443\u0434\u0438\u0442\u043E\u0440\u0438\u044E", 'Ошибка');
            console.log(err, 'Не удалось добавить аудиторию');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    ClassroomService.prototype.updateClassroom = function (id, classroom) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_CLASSROOM + "/" + id;
        classroom.id = id;
        return this.httpClient.put(url, classroom, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0414\u0430\u043D\u043D\u044B\u0435 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u044B!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0441\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u044F", 'Ошибка');
    ...
    ClassroomService.prototype.deleteClassroom = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_CLASSROOM + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0410\u0443\u0434\u0438\u0442\u043E\u0440\u0438\u044F \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0430\u0443\u0434\u0438\u0442\u043E\u0440\u0438\u044E", 'Ошибка');
            console.log(err, 'Не удалось удалить аудиторию');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    ClassroomService.prototype.getTypesOfClassroom = function () {
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TYPE_OF_CLASSROOM);
    };
    ClassroomService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] }
    ]; };
...
var DepartmentService = /** @class */ (function () {
    function DepartmentService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    DepartmentService.prototype.getDepartment = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DEPARTMENT + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    DepartmentService.prototype.getDepartments = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DEPARTMENT).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    ...
    DepartmentService.prototype.saveDepartment = function (department) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DEPARTMENT, department).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u041A\u0430\u0444\u0435\u0434\u0440\u0430 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043A\u0430\u0444\u0435\u0434\u0440\u0443", 'Ошибка');
            console.log(err, 'Не удалось добавить кафедру');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DepartmentService.prototype.updateDepartment = function (id, department) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DEPARTMENT + "/" + id;
        department.id = id;
        return this.httpClient.put(url, department, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
    ...
    DepartmentService.prototype.deleteDepartment = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DEPARTMENT + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u041A\u0430\u0444\u0435\u0434\u0440\u0430 \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u043A\u0430\u0444\u0435\u0434\u0440\u0443", 'Ошибка');
...
var DescriptionOfPlanService = /** @class */ (function () {
    function DescriptionOfPlanService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    DescriptionOfPlanService.prototype.getDescriptionOfPlan = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    DescriptionOfPlanService.prototype.getDescriptionOfPlans = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DescriptionOfPlanService.prototype.deleteDescriptionOfPlan = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0423\u0447\u0435\u0431\u043D\u044B\u0439 \u043F\u043B\u0430\u043D \u0443\u0434\u0430\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0443\u0447\u0435\u0431\u043D\u044B\u0439 \u043F\u043B\u0430\u043D", 'Ошибка');
            console.log(err, 'Не удалось удалить учебный план');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DescriptionOfPlanService.prototype.saveDescriptionOfPlan = function (descriptionOfPlan) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN, descriptionOfPlan).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0423\u0447\u0435\u0431\u043D\u044B\u0439 \u043F\u043B\u0430\u043D \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0443\u0447\u0435\u0431\u043D\u044B\u0439 \u043F\u043B\u0430\u043D", 'Ошибка');
            console.log(err, 'Не удалось добавить учебный план');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DescriptionOfPlanService.prototype.updateDescriptionOfPlan = function (id, descrOfPlan) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN + "/" + id;
        descrOfPlan.id = id;
        return this.httpClient.put(url, descrOfPlan, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0414\u0430\u043D\u043D\u044B\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u044B!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DescriptionOfPlanService.prototype.getTypesOfWork = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TYPE_OF_WORK).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DescriptionOfPlanService.prototype.getAllLessonPlansOfDescrOfPlan = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN + "/" + id + "/lesson_plans";
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    DescriptionOfPlanService.prototype.addlLessonPlansOfDescrOfPlan = function (idDescrOfPlan, lessonPlan) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN + "/" + idDescrOfPlan + "/lesson_plans";
        return this.httpClient.post(url, lessonPlan, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C \u0443\u0447\u0435\u0431\u043D\u043E\u0433\u043E \u043F\u043B\u0430\u043D\u0430", 'Ошибка');
            console.log(err, 'Не удалось добавить запись учебного плана');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DescriptionOfPlanService.prototype.deleteLessonPlanOfDescrOfPlan = function (idDescrOfPlan, idLessonPlan) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DESCRIPTION_OF_PLAN + "/" + idDescrOfPlan + "/lesson_plans/" + idLessonPlan;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C \u0443\u0447\u0435\u0431\u043D\u043E\u0433\u043E \u043F\u043B\u0430\u043D\u0430", 'Ошибка');
            console.log(err, 'Не удалось удалить запись учебного плана');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    DescriptionOfPlanService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] }
    ]; };
    ...
    return DescriptionOfPlanService;
}());
...
var DisciplinesService = /** @class */ (function () {
    function DisciplinesService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    DisciplinesService.prototype.getDisciplines = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DISCIPLINE).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Не удалось получить данные');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    };
    DisciplinesService.prototype.getDiscipline = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DISCIPLINE + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Не удалось получить данные');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    };
    DisciplinesService.prototype.saveDisciplines = function (discipline) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DISCIPLINE, discipline).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () { return _this.toastr.success("\u041F\u0440\u0435\u0434\u043C\u0435\u0442 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043F\u0440\u0435\u0434\u043C\u0435\u0442", 'Ошибка');
            console.log(err, 'Не удалось сохранить данные');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    };
    DisciplinesService.prototype.updateDiscipline = function (id, discipline) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DISCIPLINE + "/" + id;
        discipline.id = id;
        return this.httpClient.put(url, discipline, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
            console.log(err, 'Не удалось обновить данные');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])(null);
        }));
    };
    DisciplinesService.prototype.deleteDiscipline = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_DISCIPLINE + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function () { return _this.toastr.success("\u041F\u0440\u0435\u0434\u043C\u0435\u0442 \u0443\u0434\u0430\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u0440\u0435\u0434\u043C\u0435\u0442", 'Ошибка');
...
var EmployeeService = /** @class */ (function () {
    function EmployeeService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    ...
    EmployeeService.prototype.getEmployee = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_EMPLOYEE + "/" + id;
        return this.httpClient.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
    ...
    EmployeeService.prototype.saveEmployee = function (employee) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_EMPLOYEE, employee).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0421\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0441\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A\u0430", 'Ошибка');
    ...
    EmployeeService.prototype.updateEmployee = function (id, employee) {
        ...
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_EMPLOYEE + "/" + id;
        employee.id = id;
        return this.httpClient.put(url, employee, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    ...
    EmployeeService.prototype.deleteEmployee = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_EMPLOYEE + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0421\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A \u0443\u0434\u0430\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0441\u043E\u0442\u0440\u0443\u0434\u043D\u0438\u043A\u0430", 'Ошибка');
            console.log(err, 'Не удалось удалить сотрудника');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    EmployeeService.prototype.getTypesOfPOsition = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TYPE_OF_POSITION).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0442\u0432\u0443\u0435\u0442 \u0441\u0432\u044F\u0437\u044C \u0441 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
...
var GroupService = /** @class */ (function () {
    function GroupService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    GroupService.prototype.getGroup = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    GroupService.prototype.getGroups = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    ...
    GroupService.prototype.saveGroup = function (group) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP, group).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0413\u0440\u0443\u043F\u043F\u0430 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0433\u0440\u0443\u043F\u043F\u0443", 'Ошибка');
            console.log(err, 'Не удалось добавить группу');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    GroupService.prototype.updateGroup = function (id, group) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP + "/" + id;
        group.id = id;
        return this.httpClient.put(url, group, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    ...
    GroupService.prototype.deleteGroup = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0413\u0440\u0443\u043F\u043F\u0430 \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0433\u0440\u0443\u043F\u043F\u0443", 'Ошибка');
            console.log(err, 'Не удалось удалить группу');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    GroupService.prototype.saveNumberOfStudents = function (numberOfPersons) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP + "/quantity";
        return this.httpClient.post(url, numberOfPersons).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0441\u0442\u0443\u0434\u0435\u043D\u0442\u043E\u0432 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u043E \u0432 \u0433\u0440\u0443\u043F\u043F\u0443!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u0441\u0442\u0443\u0434\u0435\u043D\u0442\u043E\u0432 \u0432 \u0433\u0440\u0443\u043F\u043F\u0443", 'Ошибка');
            console.log(err, 'Не удалось добавить студентов в группу');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    GroupService.prototype.getAllNumberOfStudents = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP + "/quantity/group/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    GroupService.prototype.deleteNumberOfStudents = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_GROUP + "/quantity/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
...
var TeachersService = /** @class */ (function () {
    function TeachersService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    ...
    TeachersService.prototype.getTeacher = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER + "/" + id;
        return this.httpClient.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
    ...
    TeachersService.prototype.saveTeacher = function (teacher) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER, teacher).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u041F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044C \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044F", 'Ошибка');
            console.log(err, 'Не удалось добавить преподавателя');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TeachersService.prototype.updateTeacher = function (id, teacher) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER + "/" + id;
        teacher.id = id;
        return this.httpClient.put(url, teacher, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    ...
    TeachersService.prototype.deleteTeacher = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u041F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044C \u0443\u0434\u0430\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044F", 'Ошибка');
            console.log(err, 'Не удалось удалить преподавателя');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TeachersService.prototype.getTypesOfEmployment = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TYPE_OF_EMPLOYMENT).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TeachersService.prototype.addDisciplineToTeacher = function (idTeacher, idDiscipline) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER + "/" + idTeacher + "/disciplines/" + idDiscipline;
        return this.httpClient.put(url, [idTeacher, idDiscipline], httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u043F\u0440\u0435\u0434\u043C\u0435\u0442", 'Ошибка');
            console.log(err, 'Не удалось добавить предмет');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TeachersService.prototype.getAllDisciplinesOfTeacher = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER + "/" + id + "/disciplines";
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    TeachersService.prototype.deleteDisciplineOfTeacher = function (idTeacher, idDiscipline) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TEACHER + "/" + idTeacher + "/disciplines/" + idDiscipline;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u0440\u0435\u0434\u043C\u0435\u0442 \u043F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u044F", 'Ошибка');
...
var TimetableOfClassesService = /** @class */ (function () {
    function TimetableOfClassesService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    TimetableOfClassesService.prototype.getTimetableOfClasses = function (time) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/span" + time;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.info("\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u043F\u0435\u0440\u0438\u043E\u0434");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.getTimetableOfClassesOfGroup = function (time, groupId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/span/group/" + groupId + time;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.info("\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u043F\u0435\u0440\u0438\u043E\u0434");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    TimetableOfClassesService.prototype.getTimetableOfClassesOfTeacher = function (time, teacherId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/span/teacher/" + teacherId + time;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.info("\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u043F\u0435\u0440\u0438\u043E\u0434");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    TimetableOfClassesService.prototype.getTimetableOfClassesOfClassroom = function (time, classroomId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/span/classroom/" + classroomId + time;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.info("\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u043F\u0435\u0440\u0438\u043E\u0434");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    TimetableOfClassesService.prototype.findAllSpanByGroupId = function (groupId) {
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/need/" + groupId;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.findAllSpanByGroupIdFilterDiscipline = function (groupId, discId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/need/" + groupId + "?d=" + discId;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.info("\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u043F\u043E \u0437\u0430\u0434\u0430\u043D\u043D\u043E\u043C\u0443 \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u0443");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.saveOneTimetableOfClasses = function (timetable) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES, timetable).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u0417\u0430\u043F\u0438\u0441\u044C \u043D\u0435 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0430", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.getOneTimetableOfClasses = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.info("\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445 \u0437\u0430 \u043F\u0435\u0440\u0438\u043E\u0434");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    TimetableOfClassesService.prototype.updateOneTimetableOfClasses = function (id, newTimetable) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/" + id;
        return this.httpClient.put(url, newTimetable).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u0417\u0430\u043F\u0438\u0441\u044C \u043D\u0435 \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0430", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.deleteOneTimetableOfClasses = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0437\u0430\u043F\u0438\u0441\u044C", 'Ошибка');
    ...
    TimetableOfClassesService.prototype.getAllFreeClassrooms = function (date, startTime, endTime) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/free?d=" + date + "&t1=" + startTime + "&t2=" + endTime;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.info("\u041D\u0435\u0442 \u0441\u0432\u043E\u0431\u043E\u0434\u043D\u044B\u0445 \u0430\u0443\u0434\u0438\u0442\u043E\u0440\u0438\u0439");
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.confirmTimetableForPeriod = function (startDate, endDate) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/confirm/span?d1=" + startDate + "&d2=" + endDate;
        return this.httpClient.put(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u0438 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u0417\u0430\u043F\u0438\u0441\u0438 \u043D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.confirmTimetableForGroup = function (startDate, endDate, groupId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/confirm/group/" + groupId + "?d1=" + startDate + "&d2=" + endDate;
        return this.httpClient.put(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u0438 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u0417\u0430\u043F\u0438\u0441\u0438 \u043D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    TimetableOfClassesService.prototype.confirmTimetableForTeacher = function (startDate, endDate, teacherId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/confirm/teacher/" + teacherId + "?d1=" + startDate + "&d2=" + endDate;
        return this.httpClient.put(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u0438 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u0417\u0430\u043F\u0438\u0441\u0438 \u043D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    TimetableOfClassesService.prototype.confirmTimetable = function (timetableId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/confirms";
        return this.httpClient.put(url, timetableId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u0438 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u0417\u0430\u043F\u0438\u0441\u0438 \u043D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D\u044B", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.prototype.cancelTimetable = function (timetableId) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TIMETABLE_OF_CLASSES + "/cancel";
        return this.httpClient.put(url, timetableId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u0438 \u043E\u0442\u043C\u0435\u043D\u0435\u043D\u044B!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u0417\u0430\u043F\u0438\u0441\u0438 \u043D\u0435 \u043E\u0442\u043C\u0435\u043D\u0435\u043D\u044B", 'Ошибка');
            console.log(err, 'Не удалось обновить запись');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TimetableOfClassesService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] }
    ]; };
    ...
    return TimetableOfClassesService;
}());
...
var TypeOfCourseService = /** @class */ (function () {
    function TypeOfCourseService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    TypeOfCourseService.prototype.getTypesOfCourse = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TYPE_OF_COURSE).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TypeOfCourseService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] }
    ]; };
...
var TypeOfEducationService = /** @class */ (function () {
    function TypeOfEducationService(httpClient, toastr) {
        this.httpClient = httpClient;
        this.toastr = toastr;
    }
    TypeOfEducationService.prototype.getTypesOfEducation = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_TYPE_OF_EDUCATION).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    TypeOfEducationService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] }
    ]; };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUser = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER + "/" + id;
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    UserService.prototype.getUsers = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    ...
    UserService.prototype.saveUser = function (user) {
        var _this = this;
        return this.httpClient.post(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER, user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error('Не удалось добавить пользователя', 'Ошибка');
    ...
    UserService.prototype.updateUser = function (id, user) {
        ...
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER + "/" + id;
        user.id = id;
        return this.httpClient.put(url, user, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F", 'Ошибка');
    ...
    UserService.prototype.deleteUser = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER + "/" + id;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C \u0443\u0434\u0430\u043B\u0435\u043D!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F", 'Ошибка');
    ...
    UserService.prototype.getAllRoles = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_ROLE).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    UserService.prototype.getAllRolesOfUser = function (id) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER + "/" + id + "/roles";
        return this.httpClient.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
    ...
    UserService.prototype.deleteUserRole = function (id, role) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER + "/" + id + "/roles?rolename=" + role;
        return this.httpClient.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0417\u0430\u043F\u0438\u0441\u044C \u0443\u0434\u0430\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0440\u043E\u043B\u044C", 'Ошибка');
            console.log(err, 'Не удалось удалить роль');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    UserService.prototype.addRoleToUser = function (userId, role) {
        var _this = this;
        var url = _url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_USER + "/" + userId + "/roles?rolename=" + role;
        return this.httpClient.put(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.toastr.success("\u0420\u043E\u043B\u044C \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D\u0430!"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0434\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0440\u043E\u043B\u044C", 'Ошибка');
            console.log(err, 'Не удалось добавить роль');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
    };
    UserService.prototype.getAllStatuses = function () {
        var _this = this;
        return this.httpClient.get(_url_constants__WEBPACK_IMPORTED_MODULE_5__["UrlConstants"].URL_STATUS).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (err) {
            _this.toastr.error("\u041E\u0442\u0441\u0443\u0442\u0441\u0432\u0443\u044E\u0442 \u0434\u0430\u043D\u043D\u044B\u0435 \u0432 \u0411\u0414", 'Ошибка');
            console.log(err, 'Отсутсвуют данные в БД');
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(null);
        }));
...
var BookingComponent = /** @class */ (function () {
    function BookingComponent(el, timetableOfClassesService) {
        this.el = el;
        this.timetableOfClassesService = timetableOfClassesService;
        this.isNew = null;
        this.header = {
    ...
    // метод для передачи Диме периода для ивентов из БД
    BookingComponent.prototype.getDaysPeriod = function () {
        var _this = this;
        var startDay = this.fullcalendar.getApi().view.currentStart;
        var endDay = this.fullcalendar.getApi().view.currentEnd;
        startDay.setDate(startDay.getDate() + 1);
        var start = startDay.toISOString().split('T')[0];
        var end = endDay.toISOString().split('T')[0];
        console.log('?classDate1=' + start + '&classDate2=' + end);
    ...
    BookingComponent.prototype.handleDateClick = function (arg) {
        //  alert(arg.dateStr);
        console.log(arg);
    ...
    BookingComponent.prototype.eventClick = function (info) {
        console.log(info.event);
        if (info.event.startEditable === true) {
            this.isNew = false;
            var eventId_1 = parseInt(info.event.id, 10);
            var timetable = this.timetableOfClasses.find(function (obj) { return obj.id === eventId_1; });
            console.log(timetable);
            var updateEvent = new _shared_models_timetable_of_classes_model__WEBPACK_IMPORTED_MODULE_2__["NewEvent"]();
    ...
    BookingComponent.prototype.createNewEvent = function (arg) {
        var newEvent = new _shared_models_timetable_of_classes_model__WEBPACK_IMPORTED_MODULE_2__["NewEvent"]();
        newEvent.title = 'lalala';
        newEvent.day = arg.dateStr.split('T')[0];
        var day = new Date(arg.date);
        console.log(day);
    ...
    BookingComponent.prototype.eventRender = function (info) {
        // console.log(info);
    ...
    BookingComponent.prototype.handleEventMouseLeave = function () {
        this.tooltip.dispose();
    };
    BookingComponent.prototype.onCloseTimetableDetail = function () {
        this.timetableDetail = null;
        this.isNew = null;
    };
    BookingComponent.prototype.onAdd = function (event) {
        var _this = this;
        this.timetableDetail = event;
        console.log(this.timetableDetail);
        var timetable = new _shared_models_timetable_of_classes_model__WEBPACK_IMPORTED_MODULE_2__["TimetableOfClassesDto"]();
        timetable.id = null;
        ...
        console.log(timetable);
        this.timetableOfClassesService.saveOneTimetableOfClasses(timetable).subscribe(function () {
            _this.getDaysPeriod();
        });
        this.onCloseTimetableDetail();
    };
    BookingComponent.prototype.onUpdate = function (event) {
        var _this = this;
        this.timetableDetail = event;
        console.log(this.timetableDetail);
        var timetable = new _shared_models_timetable_of_classes_model__WEBPACK_IMPORTED_MODULE_2__["TimetableOfClassesDto"]();
        ...
        console.log(timetable);
        this.timetableOfClassesService.updateOneTimetableOfClasses(timetable.id, timetable).subscribe(function () {
            _this.getDaysPeriod();
        });
        this.onCloseTimetableDetail();
    };
    BookingComponent.prototype.onDelete = function (event) {
        var _this = this;
        this.timetableOfClassesService.deleteOneTimetableOfClasses(event.id).subscribe(function () {
            _this.getDaysPeriod();
        });
        this.onCloseTimetableDetail();
    };
...
var TimetableDetailComponent = /** @class */ (function () {
    function TimetableDetailComponent(formBuilder, groupService, disciplinesService, teachersService, descriptionOfPlanService, classroomsService, timetableOfClassesService) {
        this.formBuilder = formBuilder;
        this.groupService = groupService;
        this.disciplinesService = disciplinesService;
        this.teachersService = teachersService;
    ...
    TimetableDetailComponent.prototype.ngOnChanges = function (simpleChanges) {
        console.log(simpleChanges);
        if (simpleChanges.event && simpleChanges.event.currentValue) {
            this.detailBookingForm.patchValue(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.event));
        }
    };
    TimetableDetailComponent.prototype.onAdd = function () {
        var newEvent = this.detailBookingForm.value;
        console.log(newEvent);
        this.add.emit(newEvent);
    };
    TimetableDetailComponent.prototype.onUpdate = function () {
        var updateEvent = this.detailBookingForm.value;
        this.update.emit(updateEvent);
    };
    TimetableDetailComponent.prototype.onDelete = function () {
        var deleteEvent = this.detailBookingForm.value;
        this.delete.emit(deleteEvent);
    };
    TimetableDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.groupService.getGroups().subscribe(function (res) {
            _this.groups = res;
        });
        this.disciplinesService.getDisciplines().subscribe(function (res) {
            _this.disciplines = res;
        });
        this.teachersService.getTeachers().subscribe(function (res) {
            _this.teachers = res;
        });
        this.descriptionOfPlanService.getTypesOfWork().subscribe(function (res) {
            _this.typesOfWork = res;
        });
        this.classroomsService.getClassrooms().subscribe(function (res) {
            _this.classrooms = res;
        });
    ...
    TimetableDetailComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _shared_services_group_service__WEBPACK_IMPORTED_MODULE_3__["GroupService"] },
        { type: _shared_services_disciplines_service__WEBPACK_IMPORTED_MODULE_4__["DisciplinesService"] },
        { type: _shared_services_teachers_service__WEBPACK_IMPORTED_MODULE_5__["TeachersService"] },
    ...
    return TimetableDetailComponent;
}());
...
var RetrainingComponent = /** @class */ (function () {
    function RetrainingComponent(timetableOfClassesService, groupService, disciplinesService) {
        this.timetableOfClassesService = timetableOfClassesService;
        this.groupService = groupService;
        this.disciplinesService = disciplinesService;
        this._opened = false;
    ...
    // ------------------- методы sidebar ---------------------------------------------//
    RetrainingComponent.prototype._toggleOpened = function () {
        this._opened = !this._opened;
    };
    RetrainingComponent.prototype._toggleMode = function () {
        this._modeNum++;
        if (this._modeNum === this._MODES.length) {
            this._modeNum = 0;
        }
    };
    RetrainingComponent.prototype._toggleAutoCollapseHeight = function () {
        this._autoCollapseHeight = this._autoCollapseHeight ? null : 300;
    };
    RetrainingComponent.prototype._toggleAutoCollapseWidth = function () {
        this._autoCollapseWidth = this._autoCollapseWidth ? null : 500;
    };
    RetrainingComponent.prototype._togglePosition = function () {
        this._positionNum++;
        if (this._positionNum === this._POSITIONS.length) {
            this._positionNum = 0;
        }
    };
    RetrainingComponent.prototype._toggleDock = function () {
        this._dock = !this._dock;
    };
    RetrainingComponent.prototype._toggleCloseOnClickOutside = function () {
        this._closeOnClickOutside = !this._closeOnClickOutside;
    };
    RetrainingComponent.prototype._toggleCloseOnClickBackdrop = function () {
        this._closeOnClickBackdrop = !this._closeOnClickBackdrop;
    };
    RetrainingComponent.prototype._toggleShowBackdrop = function () {
        this._showBackdrop = !this._showBackdrop;
    };
    RetrainingComponent.prototype._toggleAnimate = function () {
        this._animate = !this._animate;
    };
    RetrainingComponent.prototype._toggleTrapFocus = function () {
        this._trapFocus = !this._trapFocus;
    };
    RetrainingComponent.prototype._toggleAutoFocus = function () {
        this._autoFocus = !this._autoFocus;
    };
    RetrainingComponent.prototype._toggleKeyClose = function () {
        this._keyClose = !this._keyClose;
    };
    RetrainingComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.groupService.getGroups().subscribe(function (res) {
            _this.groups = res;
        });
    ...
    RetrainingComponent.prototype.ngAfterViewChecked = function () { };
    RetrainingComponent.prototype.onSubmit = function () {
        var _this = this;
        console.log(this.group);
        if (this.discipline) {
            this.timetableOfClassesService.findAllSpanByGroupIdFilterDiscipline(this.group, this.discipline).
                ...
                if (res != null) {
                    ...
                    _this.externalEvents.sort(function (a, b) {
                        if (a.title < b.title) {
                            return -1;
                        }
                        if (a.title > b.title) {
                    ...
                    console.log(_this.externalEvents);
                }
            });
        }
        else {
            this.timetableOfClassesService.findAllSpanByGroupId(this.group).subscribe(function (res) {
                //   console.log(res);
                _this.externalEvents = [];
                if (res != null) {
                    for (var i = 0, len = Object.keys(res).length; i < len; i++) {
    ...
    RetrainingComponent.prototype.onRequestNewEvent = function (e) {
        this.isNew = true;
        this.timetableDetail = e;
    };
    RetrainingComponent.prototype.onRequestUpdateEvent = function (e) {
        this.isNew = false;
        this.timetableDetail = e;
    };
    RetrainingComponent.prototype.onCloseTimetableDetail = function () {
        this.timetableDetail = null;
        this.isNew = null;
    };
    RetrainingComponent.prototype.onAdd = function (event) {
        // this.appointments = [...this.appointments, { id: new Date().getTime().toString(), ...appointment }];
        this.onCloseTimetableDetail();
    };
    RetrainingComponent.prototype.onUpdate = function (event) {
        /* this.appointments = this.appointments.map(
             a => a.id === appointment.id ? { ...a, ...appointment } : a
         );*/
        this.onCloseTimetableDetail();
    };
    RetrainingComponent.prototype.onEventUpdated = function (event) {
        this.onUpdate(event);
    };
    RetrainingComponent.prototype.onClickButtonOk = function (event) {
        this.onSubmit();
    };
    RetrainingComponent.ctorParameters = function () { return [
...
var TimetableConfirmComponent = /** @class */ (function () {
    function TimetableConfirmComponent(formBuilder, timetableOfClassesService, groupService, teacherService, toastr, classroomService) {
        this.formBuilder = formBuilder;
        this.timetableOfClassesService = timetableOfClassesService;
        this.groupService = groupService;
        this.teacherService = teacherService;
    ...
    TimetableConfirmComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.groupService.getGroups().subscribe(function (res) {
            _this.groups = res;
        });
    ...
    TimetableConfirmComponent.prototype.checkUncheckAll = function () {
        for (var i = 0; i < this.timetables.length; i++) {
            this.timetables[i].isSelected = this.masterSelected;
        }
        this.getCheckedItemList();
    };
    TimetableConfirmComponent.prototype.isAllSelected = function () {
        this.masterSelected = this.timetables.every(function (item) {
            return item.isSelected === true;
        });
        this.getCheckedItemList();
    };
    TimetableConfirmComponent.prototype.getCheckedItemList = function () {
    ...
    TimetableConfirmComponent.prototype.onClose = function () {
        this.closed.emit('close');
    };
    TimetableConfirmComponent.prototype.loadTimetableToConfirmForPeriod = function () {
        var _this = this;
        var start = this.confirmForPeriodForm.get('startDate').value;
        var end = this.confirmForPeriodForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
        this.timetableOfClassesService.getTimetableOfClasses(time).subscribe(function (data) {
            _this.timetables = [];
            for (var i = 0, len = Object.keys(data).length; i < len; i++) {
                if (data[i].status === false && data[i].reserved === false) {
                    // не подтвержденные ивенты
                    _this.timetables.push({
                        id: data[i].id,
    ...
    TimetableConfirmComponent.prototype.loadTimetableToConfirmForGroup = function () {
        var _this = this;
        var start = this.confirmForGroupForm.get('startDate').value;
        var end = this.confirmForGroupForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
        var group = this.confirmForGroupForm.get('group').value;
        this.timetableOfClassesService.getTimetableOfClasses(time).subscribe(function (data) {
            _this.timetables = [];
            for (var i = 0, len = Object.keys(data).length; i < len; i++) {
    ...
    TimetableConfirmComponent.prototype.loadTimetableToConfirmForTeacher = function () {
        var _this = this;
        var start = this.confirmForTeacherForm.get('startDate').value;
        var end = this.confirmForTeacherForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
        var teacher = this.confirmForTeacherForm.get('teacher').value;
        this.timetableOfClassesService.getTimetableOfClasses(time).subscribe(function (data) {
            _this.timetables = [];
            for (var i = 0, len = Object.keys(data).length; i < len; i++) {
    ...
    TimetableConfirmComponent.prototype.loadTimetableToConfirmForClassroom = function () {
        var _this = this;
        var start = this.confirmForClassroomForm.get('startDate').value;
        var end = this.confirmForClassroomForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
        var classroom = this.confirmForClassroomForm.get('classroom').value;
        this.timetableOfClassesService.getTimetableOfClasses(time).subscribe(function (data) {
            _this.timetables = [];
            for (var i = 0, len = Object.keys(data).length; i < len; i++) {
    ...
    TimetableConfirmComponent.prototype.confirmTimetables = function () {
    ...
    TimetableConfirmComponent.prototype.cancelTimetables = function () {
        console.log(this.checkedTimetables);
        if (this.checkedTimetables !== undefined && this.checkedTimetables.length !== 0) {
    ...
    TimetableConfirmComponent.prototype.loadTimetableToCancelForPeriod = function () {
        var _this = this;
        var start = this.confirmForPeriodForm.get('startDate').value;
        var end = this.confirmForPeriodForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
    ...
    TimetableConfirmComponent.prototype.loadTimetableToCancelForGroup = function () {
        var _this = this;
        var start = this.confirmForGroupForm.get('startDate').value;
        var end = this.confirmForGroupForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
    ...
    TimetableConfirmComponent.prototype.loadTimetableToCancelForTeacher = function () {
        var _this = this;
        var start = this.confirmForTeacherForm.get('startDate').value;
        var end = this.confirmForTeacherForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
    ...
    TimetableConfirmComponent.prototype.loadTimetableToCancelForClassroom = function () {
        var _this = this;
        var start = this.confirmForClassroomForm.get('startDate').value;
        var end = this.confirmForClassroomForm.get('endDate').value;
        var time = '?d1=' + start + '&d2=' + end;
        var classroom = this.confirmForClassroomForm.get('teacher').value;
        this.timetableOfClassesService.getTimetableOfClasses(time).subscribe(function (data) {
            _this.timetables = [];
            for (var i = 0, len = Object.keys(data).length; i < len; i++) {
    ...
    TimetableConfirmComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _shared_services_timetable_of_classes_service__WEBPACK_IMPORTED_MODULE_3__["TimetableOfClassesService"] },
        { type: _shared_services_group_service__WEBPACK_IMPORTED_MODULE_4__["GroupService"] },
        { type: _shared_services_teachers_service__WEBPACK_IMPORTED_MODULE_5__["TeachersService"] },
    ...
    return TimetableConfirmComponent;
}());
...
var TimetableComponent = /** @class */ (function () {
    function TimetableComponent(el, classroomService, timetableOfClassesService, authService) {
        var _this = this;
        this.el = el;
        this.classroomService = classroomService;
        this.timetableOfClassesService = timetableOfClassesService;
        ...
        this.classroomService.getClassrooms().subscribe(function (res) {
            _this.resources = [];
            for (var i = 0, len = Object.keys(res).length; i < len; i++) {
                _this.resources.push({ id: (res[i].id).toString(), title: res[i].number });
            }
    ...
    TimetableComponent.prototype.ngAfterViewInit = function () {
        new _fullcalendar_interaction__WEBPACK_IMPORTED_MODULE_3__["Draggable"](this.external.nativeElement, {
            ...
            eventData: function (eventEl) {
                var data = eventEl.getAttribute('data-event');
    ...
    Object.defineProperty(TimetableComponent.prototype, "isAdmin", {
        get: function () {
            var role = this.authService.userRole;
            if (role === 'ROLE_ADMIN') {
                return true;
    ...
    TimetableComponent.prototype.eventDragStop = function (event) {
        var _this = this;
        var trashEl = document.getElementById('fcTrash');
        var x1 = trashEl.offsetLeft - 100;
        var x2 = trashEl.offsetLeft + trashEl.offsetWidth + 20;
        var y1 = trashEl.offsetTop + 60;
        var y2 = trashEl.offsetTop + trashEl.offsetHeight + 120;
        if (event.jsEvent.pageX >= x1 && event.jsEvent.pageX <= x2 &&
            ...
            this.timetableOfClassesService.deleteOneTimetableOfClasses(id).subscribe(function (res) {
                if (res === null) {
                    event.event.remove();
                    _this.clickButtonOk.emit('OK');
                }
            });
        }
    };
    TimetableComponent.prototype.getEvent = function (event) {
        return JSON.stringify(event);
    };
    // сборка объекта для отправки на сервер
    TimetableComponent.prototype.getTimetableObjectWithResource = function (dataObj, event) {
        var _this = this;
        var timetable = new _shared_models_timetable_of_classes_model__WEBPACK_IMPORTED_MODULE_7__["TimetableOfClassesDto"]();
        timetable.id = null;
        ...
        this.classroomService.getClassroom(classroomId).subscribe(function (res) {
            timetable.classroomDto = {
                id: res.id,
                number: res.number,
                typeOfClassroom: res.typeOfClassroom.id,
            ...
            _this.timetableOfClassesService.saveOneTimetableOfClasses(timetable).subscribe(function (result) {
                if (result) {
    ...
    TimetableComponent.prototype.eventReceive = function (event) {
        var time = event.event.start.toTimeString().substring(0, 5) + '-' + event.event.end.toTimeString().substring(0, 5) + ', ' +
        ...
        var need = event.draggedEl.childNodes[1].innerText;
        if (need > 1) {
        ...
        var dataObj = JSON.parse(event.draggedEl.dataset.event);
        this.getTimetableObjectWithResource(dataObj, event);
    };
    TimetableComponent.prototype.eventDrop = function (event) {
        var _this = this;
        var id;
        if (event.event.id !== 'null') {
            id = event.event.id;
        ...
        this.timetableOfClassesService.getOneTimetableOfClasses(id).subscribe(function (res) {
            var timetable = new _shared_models_timetable_of_classes_model__WEBPACK_IMPORTED_MODULE_7__["TimetableOfClassesDto"]();
            timetable.id = res.id;
            ...
            _this.classroomService.getClassroom(classroomId).subscribe(function (res2) {
                timetable.classroomDto = {
                    id: res2.id,
                    number: res2.number,
                ...
                _this.timetableOfClassesService.updateOneTimetableOfClasses(id, timetable).subscribe(function (result) {
    ...
    TimetableComponent.prototype.getDaysPeriod = function () {
        var _this = this;
        var startDay = this.fullcalendar.getApi().view.currentStart;
        var endDay = this.fullcalendar.getApi().view.currentEnd;
        startDay.setDate(startDay.getDate() + 1);
        ...
        this.time = '?d1=' + start + '&d2=' + end;
        this.timetableOfClassesService.getTimetableOfClasses(this.time).subscribe(function (data) {
            _this.fullcalendar.getApi().removeAllEvents();
            _this.fullcalendar.getApi().removeAllEventSources();
            _this.fullcalendar.getApi().rerenderEvents();
            _this.timetableOfClasses = data;
            _this.calendarEvents = [];
            // конвертация объектов из БД в event на календарь
            for (var i = 0, len = Object.keys(data).length; i < len; i++) {
    ...
    TimetableComponent.prototype.refetchEvents = function () {
        var _this = this;
        var startDay = this.fullcalendar.getApi().view.currentStart;
        var endDay = this.fullcalendar.getApi().view.currentEnd;
        startDay.setDate(startDay.getDate() + 1);
    ...
    TimetableComponent.prototype.datesRender = function (info) {
        console.log(info);
    };
    TimetableComponent.prototype.eventRender = function (info) {
    ...
    TimetableComponent.prototype.handleEventMouseLeave = function () {
        this.tooltip.dispose();
    };
    TimetableComponent.prototype.onCloseTimetableConfirm = function (info) {
        var _this = this;
        console.log(info);
        if (info === 'close') {
    ...
    TimetableComponent.prototype.onConfirm = function () {
        this.isTimetableConfirm = !this.isTimetableConfirm;
        this.isConfirm = true;
    };
    TimetableComponent.prototype.onCancel = function () {
...
var TimetablesRoutingModule = /** @class */ (function () {
    function TimetablesRoutingModule() {
    }
    ...
    return TimetablesRoutingModule;
}());
...
/* harmony import */ var angular2_draggable__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! angular2-draggable */ "./node_modules/angular2-draggable/fesm5/angular2-draggable.js");
...
var TimetablesModule = /** @class */ (function () {
