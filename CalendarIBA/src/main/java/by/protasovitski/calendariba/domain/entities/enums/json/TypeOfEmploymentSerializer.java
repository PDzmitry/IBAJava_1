...
public class TypeOfEmploymentSerializer extends JsonSerializer<TypeOfEmployment> {
    /**
     ...
     */
    @Override
    public void serialize(TypeOfEmployment value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
