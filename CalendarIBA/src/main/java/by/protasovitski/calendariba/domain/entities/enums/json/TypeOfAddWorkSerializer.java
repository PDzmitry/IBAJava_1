...
public class TypeOfAddWorkSerializer extends JsonSerializer<TypeOfAddWork> {
     ...
     */
    @Override
    public void serialize(TypeOfAddWork value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
