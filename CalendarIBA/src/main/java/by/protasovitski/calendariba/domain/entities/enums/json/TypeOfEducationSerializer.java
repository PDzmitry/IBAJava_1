...
public class TypeOfEducationSerializer extends JsonSerializer<TypeOfEducation> {
    /**
     ...
     */
    @Override
    public void serialize(TypeOfEducation value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
