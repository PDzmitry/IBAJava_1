...
public class TypeOfWorkSerializer extends JsonSerializer<TypeOfWork> {
    /**
     ...
     */
    @Override
    public void serialize(TypeOfWork value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
